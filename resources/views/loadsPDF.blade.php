...
<head>
    ...
    <title>Reporte de cargas academicas</title>
</head>
...
<body>
    ...
    <div class="marginbody">
        <span class="font">Reporte de Cargas Academicas</span>
            ...
            <table class="styled-table">
                <thead>
                    <tr>
                        ...
                        <th class="text-center" scope="col">Hora de finalizacion</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center"><?= $load->cycle ?></td>
                        <td class="text-center"><?= $load->teacher ?></td>
                        <td class="text-center"><?= $load->subject ?></td>
                        <td class="text-center"><?= $load->start_time ?></td>
                        <td class="text-center"><?= $load->end_time ?></td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
